...
const Dashboard = (props) => {
 ...
 //console.log('DASHBOARD', props.myProfile.myProfile.name)
   return (
      ...
      <p className='lead'>
        <i className='fas fa-user' /> {props.myProfile.myProfile.name}, welcome to your new Dashboard 
      </p>
            <hr/>
            <div>
               <h4>Name: {props.myProfile.myProfile.name}</h4>
               <h4>Email: {props.myProfile.myProfile.email}</h4>
               <h4>Date Joined: {props.myProfile.myProfile.date}</h4>
            </div>
            <form>
               <input type = 'text'/>
            </form>
