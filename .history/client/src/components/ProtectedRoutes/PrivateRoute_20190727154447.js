...
const PrivateRoute = ({component: Component, auth, ...rest}) => (
   ...
   //The render function says if the props passed in (redux state) is not authenticated or loading then redirect the user to login page otherwise render the component passed in. The aut
