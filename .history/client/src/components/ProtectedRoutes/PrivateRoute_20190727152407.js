...
//We have to interact with our auth state in the redux for this to work so we will bring the connect method from redux so we have to pass in as a prop because of that we have to destructure any props comin
