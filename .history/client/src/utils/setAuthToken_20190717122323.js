...
//This works like when making request to protective you have to the token along and this is how we do it ...  x-auth-token = 332jndjcnjjjcnxcx thus the token so we want to do same on the client side
