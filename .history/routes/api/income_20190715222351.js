...
incomeRouter.post('/create', auth,  async (req, res) => {
      ...
      //We want to associate the user who has login to create the post so we can build an object to include the user in token so that we can create a data base on 
