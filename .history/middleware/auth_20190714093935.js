...
const token = req.header('x-auth-token');
   ...
   try {
    ...
    //So next we will attach this user object to our request body as req.user and this user only contains and id from our database so we can search by id and return the user
