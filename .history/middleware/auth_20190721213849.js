...
//The purpose of this middleware is to check the incoming,
//request if it has the token,
//If there is a token it extract it from the header, verify and decode.
//Decode means getting the actual user and attach it to request  body as req.user
//This means that at any route we can access that user
